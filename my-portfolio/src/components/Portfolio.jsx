    ...
    return(
        <motion.div >
            ...
            options ={{
              ...
              className ='bg-black p-5 max-sm:p-2 rounded-2xl sm:w-[360px] w-full h-[510px] max-sm:h-[620px]'
            >
                <div>
                ...
                <div className='mt-5'>
                    ...
                    <p className='mt-2 text-14px text-gray-400'>{description}</p>
                </div>
...
const Portfolio = ({ sectionId }) => {
    ...
    return (
        <div className="px-10 max-sm:px-5 pt-20 max-sm:pt-10 " id={sectionId} ref={sectionRef}>
            ...
            <div className='mt-14 flex flex-wrap gap-7 justify-center bg-white shadow-lg rounded-3xl p-10'>
            {portfolio_data.map(
                (project, index)=>(
