...
const Skills = ({ sectionId }) => {
  ...
  return (
    ...
    >
      ...
      <div className=" flex flex-wrap justify-center gap-8 bg-black rounded-3xl p-10">
        {skills_data.map((skill, index) => (
          ...
          >
            <Tilt
              ...
              className=" w-28 h-28 flex items-center justify-center rounded-full bg-white shadow-md cursor-pointer  border-2 border-[#7A78C4] hover:border-gold transition-transform"
              key={index}
            >
              <div>
